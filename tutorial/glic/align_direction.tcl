...
set im [measure inertia [atomselect top "all"] moments]
puts "measured inertia $im"
set A [orient $sel [lindex $I 2] {0 0 1}]
$sel move $A

set coma [measure center [atomselect top "chain A"] weight mass]
set comb [measure center [atomselect top "chain B"] weight mass]
set comc [measure center [atomselect top "chain C"] weight mass]
set comd [measure center [atomselect top "chain D"] weight mass]
set come [measure center [atomselect top "chain E"] weight mass]
...
[atomselect top "all"] writepdb "vmd_[lindex $argv 1]"
