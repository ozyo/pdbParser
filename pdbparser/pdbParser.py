...
from rnr import replace, rnrseg_charmm, renumberatom, addbfact , rnrch, removedrude, addchid, reordseg
...
def pdbParselocal(pdb,cwd,coortype,altloc,rname,bysegid,renumber,segids,bfact,merge,chains,drude,bfact_nr,bfact_type,namena,chid,reord):
